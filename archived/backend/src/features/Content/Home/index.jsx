  ...
  const handleUserAction = async (cardId, action) => {
    try {
      ...
      if (action === 'like') {
        ...
        // Trigger notification popup in static mode
        // The mock API already creates the notification, but we need to ensure it triggers the popup
        // This is handled by the mockData.js addNotification function which dispatches the event
      }
    } catch (error) {
