    ...
    <div style={{ display: 'flex', flexDirection: 'row', height: '100vh', width: '100%' }}>
      <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
        ...
        <div className={matchesStyles.chatContainer}>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--gap-012)', position: 'relative', minHeight: '100%' }}>
              {(!messages || messages.length === 0) ? (
                <div className={matchesStyles.emptyMessages} style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}>
